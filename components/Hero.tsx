    ...
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 animate-bg">
        ...
        <video
          ...
          style={{ opacity: 0.4, zIndex: 2 }} // increase for testing
        >
          <source src="/v1.mp4" type="video/mp4" />
        </video>

        {/* Dark scrim — sits above video so it doesn't overpower the text */}
        <div
          className="absolute inset-0"
          style={{ background: "rgba(12,10,9,0.72)" }}
        />
        {/* ────────────────────────────────────────────────────────────── */}

        {/* Original gradient overlays — unchanged */}
        <div
          className="absolute inset-0"
          style={{
            background: `
        ...
        {/* Original grid overlay — unchanged */}
        <div
      ...
      <div className="absolute right-8 top-1/3 hidden xl:block animate-float z-10">
        <div className="bg-stone-900/80 backdrop-blur border border-stone-700/50 rounded-2xl p-6 w-64 shadow-2xl hover:scale-105 transition duration-300">
          ...
          <p className="font-display text-gold-400 text-xl font-light">
            Maple Grove Estate
          </p>
          <p className="text-stone-400 text-xs mt-1">
            4 bed • 3 bath • 2,840 sqft
          </p>
      ...
      {/* Floating Card 2 */}
      <div
        className="absolute right-17 bottom-1/5 hidden xl:block animate-float z-10"
      ...
      >
        <div className="bg-gold-500/10 backdrop-blur border border-gold-500/30 rounded-xl p-4 w-44 shadow-xl hover:scale-105 transition duration-300">
          ...
          <p className="font-display text-gold-400 text-3xl font-light">
            18.4%
          </p>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-24">
        <div className="max-w-3xl">
          ...
          >
            Where{" "}
            <em className="modern-glow not-italic p-1.5 rounded-2xl mb-0.5">
              Modern
            </em>
            <br />
            Living Begins
          ...
          >
            Curated builder homes and luxury apartments crafted for the way you
            actually live. Move-in ready. No compromises.
          </p>
          ...
          <div className="grid grid-cols-3 gap-8 pt-8 border-t border-stone-800">
            {[
              ...
              >
                <p className="font-display text-3xl text-gold-400 font-light">
                  {stat.value}
                </p>
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 z-10 animate-bounce-slow">
        <span className="text-stone-300 text-xs uppercase tracking-widest">
          Scroll
        </span>
